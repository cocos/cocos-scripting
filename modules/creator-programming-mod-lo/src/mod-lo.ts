...
import { getBaseName, hasFileProtocol, replaceExtension, tryParseURL } from '@cocos/creator-programming-common/lib/url';
...
import { parseImportMap } from '@cocos/creator-programming-import-maps/lib/parse-import-map';
