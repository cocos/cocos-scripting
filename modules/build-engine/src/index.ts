...
function verifyCache (options: BuildEngineOptions): boolean {
	// TODO
	return false;
}

function applyDefaultOptions (options: BuildEngineOptions): void {
 ...
 * @group Merged Types
 */
export async function buildEngine (options: BuildEngineOptions): Promise<BuildEngineResult> {
	...
	if (options.platform === 'OPEN_HARMONY') {
		if (options.preserveType) {
			...
			return buildJsEngine(options as Required<BuildEngineOptions>);
		}
	} else {
		if (options.preserveType) {
...
function _enumerateDependentChunks (meta: BuildEngineResult, featureUnits: string[]): string[] {
...
// eslint-disable-next-line no-inner-declarations
function _enumerateDependentAssets (meta: BuildEngineResult, dependentChunks: string[]): string[] {
 ...
 */
export function enumerateDependentChunks (meta: BuildEngineResult, featureUnits: string[]): string[] {
 ...
 * @param featureUnits Feature units.
 */
export function enumerateDependentAssets (meta: BuildEngineResult, featureUnits: string[]): string[] {
 ...
 * @param featureUnits Feature units.
 */
export function enumerateAllDependents (meta: BuildEngineResult, featureUnits: string[]): string[] {
    const dependentChunks = _enumerateDependentChunks(meta, featureUnits);
